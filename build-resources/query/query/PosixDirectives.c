...
int PosixDirectives() {
    ...
    printf("NativeCodeInfo:PosixDirectives:StructInfo:mcontext_t:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(mcontext_t)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:mcontext_t:StructFieldInfo:fault_address:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(((mcontext_t *) 0)->fault_address)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:mcontext_t:StructFieldInfo:fault_address:PropertyInfo:offset=%lu\n", ((unsigned long)offsetof(mcontext_t, fault_address)));
    {
        int is_unsigned;
        unsigned long all_bits_set = -1;
        mcontext_t fieldHolder;
        memset(&fieldHolder, 0x0, sizeof(fieldHolder));
        fieldHolder.fault_address = all_bits_set;
        is_unsigned = fieldHolder.fault_address > 0;
        printf("NativeCodeInfo:PosixDirectives:StructInfo:mcontext_t:StructFieldInfo:fault_address:PropertyInfo:signedness=$%s$\n", (is_unsigned) ? "UNSIGNED" : "SIGNED");
    }
    printf("NativeCodeInfo:PosixDirectives:StructInfo:mcontext_t:StructFieldInfo:pc:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(((mcontext_t *) 0)->pc)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:mcontext_t:StructFieldInfo:pc:PropertyInfo:offset=%lu\n", ((unsigned long)offsetof(mcontext_t, pc)));
    {
        int is_unsigned;
        unsigned long all_bits_set = -1;
        mcontext_t fieldHolder;
        memset(&fieldHolder, 0x0, sizeof(fieldHolder));
        fieldHolder.pc = all_bits_set;
        is_unsigned = fieldHolder.pc > 0;
        printf("NativeCodeInfo:PosixDirectives:StructInfo:mcontext_t:StructFieldInfo:pc:PropertyInfo:signedness=$%s$\n", (is_unsigned) ? "UNSIGNED" : "SIGNED");
    }
    printf("NativeCodeInfo:PosixDirectives:StructInfo:mcontext_t:StructFieldInfo:pstate:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(((mcontext_t *) 0)->pstate)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:mcontext_t:StructFieldInfo:pstate:PropertyInfo:offset=%lu\n", ((unsigned long)offsetof(mcontext_t, pstate)));
    {
        int is_unsigned;
        unsigned long all_bits_set = -1;
        mcontext_t fieldHolder;
        memset(&fieldHolder, 0x0, sizeof(fieldHolder));
        fieldHolder.pstate = all_bits_set;
        is_unsigned = fieldHolder.pstate > 0;
        printf("NativeCodeInfo:PosixDirectives:StructInfo:mcontext_t:StructFieldInfo:pstate:PropertyInfo:signedness=$%s$\n", (is_unsigned) ? "UNSIGNED" : "SIGNED");
    }
    printf("NativeCodeInfo:PosixDirectives:StructInfo:mcontext_t:StructFieldInfo:regs:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(((mcontext_t *) 0)->regs)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:mcontext_t:StructFieldInfo:regs:PropertyInfo:offset=%lu\n", ((unsigned long)offsetof(mcontext_t, regs)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:mcontext_t:StructFieldInfo:sp:PropertyInfo:size=%lu\n", ((unsigned long)sizeof(((mcontext_t *) 0)->sp)));
    printf("NativeCodeInfo:PosixDirectives:StructInfo:mcontext_t:StructFieldInfo:sp:PropertyInfo:offset=%lu\n", ((unsigned long)offsetof(mcontext_t, sp)));
    {
        int is_unsigned;
        unsigned long all_bits_set = -1;
        mcontext_t fieldHolder;
        memset(&fieldHolder, 0x0, sizeof(fieldHolder));
        fieldHolder.sp = all_bits_set;
        is_unsigned = fieldHolder.sp > 0;
        printf("NativeCodeInfo:PosixDirectives:StructInfo:mcontext_t:StructFieldInfo:sp:PropertyInfo:signedness=$%s$\n", (is_unsigned) ? "UNSIGNED" : "SIGNED");
    }
